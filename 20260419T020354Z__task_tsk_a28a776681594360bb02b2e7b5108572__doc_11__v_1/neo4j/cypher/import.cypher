...
LOAD CSV WITH HEADERS FROM 'https://raw.githubusercontent.com/cenaia/graph/main/20260419T020354Z__task_tsk_a28a776681594360bb02b2e7b5108572__doc_11__v_1/neo4j/cypher/entities.csv' AS row
...
LOAD CSV WITH HEADERS FROM 'https://raw.githubusercontent.com/cenaia/graph/main/20260419T020354Z__task_tsk_a28a776681594360bb02b2e7b5108572__doc_11__v_1/neo4j/cypher/observations.csv' AS row
...
LOAD CSV WITH HEADERS FROM 'https://raw.githubusercontent.com/cenaia/graph/main/20260419T020354Z__task_tsk_a28a776681594360bb02b2e7b5108572__doc_11__v_1/neo4j/cypher/entity_has_observation.csv' AS row
MATCH (e:Entity {entity_id: row.entity_id})
MATCH (o:Observation {observation_id: row.observation_id})
MERGE (e)-[:HAS_OBSERVATION]->(o);

LOAD CSV WITH HEADERS FROM 'https://raw.githubusercontent.com/cenaia/graph/main/20260419T020354Z__task_tsk_a28a776681594360bb02b2e7b5108572__doc_11__v_1/neo4j/cypher/relationships.csv' AS row
WITH row WHERE row.neo4j_rel_type = 'REL_523E40A074'
MATCH (source:Entity {entity_id: row.source_entity_id})
MATCH (target:Entity {entity_id: row.target_entity_id})
CREATE (source)-[r:REL_523E40A074]->(target)
...
LOAD CSV WITH HEADERS FROM 'https://raw.githubusercontent.com/cenaia/graph/main/20260419T020354Z__task_tsk_a28a776681594360bb02b2e7b5108572__doc_11__v_1/neo4j/cypher/relationships.csv' AS row
WITH row WHERE row.neo4j_rel_type = 'REL_6931BB1DA1'
MATCH (source:Entity {entity_id: row.source_entity_id})
MATCH (target:Entity {entity_id: row.target_entity_id})
CREATE (source)-[r:REL_6931BB1DA1]->(target)
SET r.relationship_id = row.relationship_id,
    r.source = row.source,
    r.target = row.target,
    r.source_role = row.source_role,
...
LOAD CSV WITH HEADERS FROM 'https://raw.githubusercontent.com/cenaia/graph/main/20260419T020354Z__task_tsk_a28a776681594360bb02b2e7b5108572__doc_11__v_1/neo4j/cypher/relationships.csv' AS row
WITH row WHERE row.neo4j_rel_type = 'REL_76FDF5E82D'
MATCH (source:Entity {entity_id: row.source_entity_id})
MATCH (target:Entity {entity_id: row.target_entity_id})
CREATE (source)-[r:REL_76FDF5E82D]->(target)
SET r.relationship_id = row.relationship_id,
    r.source = row.source,
    r.target = row.target,
    r.source_role = row.source_role,
...
LOAD CSV WITH HEADERS FROM 'https://raw.githubusercontent.com/cenaia/graph/main/20260419T020354Z__task_tsk_a28a776681594360bb02b2e7b5108572__doc_11__v_1/neo4j/cypher/relationships.csv' AS row
WITH row WHERE row.neo4j_rel_type = 'REL_B1BABCEF8C'
MATCH (source:Entity {entity_id: row.source_entity_id})
MATCH (target:Entity {entity_id: row.target_entity_id})
CREATE (source)-[r:REL_B1BABCEF8C]->(target)
SET r.relationship_id = row.relationship_id,
    r.source = row.source,
    r.target = row.target,
    r.source_role = row.source_role,
...
LOAD CSV WITH HEADERS FROM 'https://raw.githubusercontent.com/cenaia/graph/main/20260419T020354Z__task_tsk_a28a776681594360bb02b2e7b5108572__doc_11__v_1/neo4j/cypher/relationships.csv' AS row
WITH row WHERE row.neo4j_rel_type = 'REL_B3FF0C7392'
MATCH (source:Entity {entity_id: row.source_entity_id})
MATCH (target:Entity {entity_id: row.target_entity_id})
CREATE (source)-[r:REL_B3FF0C7392]->(target)
SET r.relationship_id = row.relationship_id,
    r.source = row.source,
    r.target = row.target,
    r.source_role = row.source_role,
...
LOAD CSV WITH HEADERS FROM 'https://raw.githubusercontent.com/cenaia/graph/main/20260419T020354Z__task_tsk_a28a776681594360bb02b2e7b5108572__doc_11__v_1/neo4j/cypher/relationships.csv' AS row
WITH row WHERE row.neo4j_rel_type = 'REL_B56D9AC6C5'
MATCH (source:Entity {entity_id: row.source_entity_id})
MATCH (target:Entity {entity_id: row.target_entity_id})
CREATE (source)-[r:REL_B56D9AC6C5]->(target)
SET r.relationship_id = row.relationship_id,
    r.source = row.source,
    r.target = row.target,
    r.source_role = row.source_role,
...
LOAD CSV WITH HEADERS FROM 'https://raw.githubusercontent.com/cenaia/graph/main/20260419T020354Z__task_tsk_a28a776681594360bb02b2e7b5108572__doc_11__v_1/neo4j/cypher/relationships.csv' AS row
WITH row WHERE row.neo4j_rel_type = 'REL_BD64B73930'
MATCH (source:Entity {entity_id: row.source_entity_id})
MATCH (target:Entity {entity_id: row.target_entity_id})
CREATE (source)-[r:REL_BD64B73930]->(target)
SET r.relationship_id = row.relationship_id,
    r.source = row.source,
    r.target = row.target,
    r.source_role = row.source_role,
...
LOAD CSV WITH HEADERS FROM 'https://raw.githubusercontent.com/cenaia/graph/main/20260419T020354Z__task_tsk_a28a776681594360bb02b2e7b5108572__doc_11__v_1/neo4j/cypher/relationships.csv' AS row
WITH row WHERE row.neo4j_rel_type = 'REL_C11219E27C'
MATCH (source:Entity {entity_id: row.source_entity_id})
MATCH (target:Entity {entity_id: row.target_entity_id})
CREATE (source)-[r:REL_C11219E27C]->(target)
SET r.relationship_id = row.relationship_id,
    r.source = row.source,
    r.target = row.target,
    r.source_role = row.source_role,
...
LOAD CSV WITH HEADERS FROM 'https://raw.githubusercontent.com/cenaia/graph/main/20260419T020354Z__task_tsk_a28a776681594360bb02b2e7b5108572__doc_11__v_1/neo4j/cypher/relationships.csv' AS row
WITH row WHERE row.neo4j_rel_type = 'REL_C64883763F'
MATCH (source:Entity {entity_id: row.source_entity_id})
MATCH (target:Entity {entity_id: row.target_entity_id})
CREATE (source)-[r:REL_C64883763F]->(target)
SET r.relationship_id = row.relationship_id,
    r.source = row.source,
    r.target = row.target,
    r.source_role = row.source_role,
...
LOAD CSV WITH HEADERS FROM 'https://raw.githubusercontent.com/cenaia/graph/main/20260419T020354Z__task_tsk_a28a776681594360bb02b2e7b5108572__doc_11__v_1/neo4j/cypher/relationships.csv' AS row
WITH row WHERE row.neo4j_rel_type = 'REL_C87CBD5FC8'
MATCH (source:Entity {entity_id: row.source_entity_id})
MATCH (target:Entity {entity_id: row.target_entity_id})
CREATE (source)-[r:REL_C87CBD5FC8]->(target)
SET r.relationship_id = row.relationship_id,
    r.source = row.source,
    r.target = row.target,
    r.source_role = row.source_role,
...
LOAD CSV WITH HEADERS FROM 'https://raw.githubusercontent.com/cenaia/graph/main/20260419T020354Z__task_tsk_a28a776681594360bb02b2e7b5108572__doc_11__v_1/neo4j/cypher/relationships.csv' AS row
WITH row WHERE row.neo4j_rel_type = 'REL_D9B0234874'
MATCH (source:Entity {entity_id: row.source_entity_id})
MATCH (target:Entity {entity_id: row.target_entity_id})
CREATE (source)-[r:REL_D9B0234874]->(target)
SET r.relationship_id = row.relationship_id,
    r.source = row.source,
    r.target = row.target,
    r.source_role = row.source_role,
