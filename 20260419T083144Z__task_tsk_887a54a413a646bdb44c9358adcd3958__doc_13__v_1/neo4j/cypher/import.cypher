...
LOAD CSV WITH HEADERS FROM 'https://raw.githubusercontent.com/cenaia/graph/main/20260419T083144Z__task_tsk_887a54a413a646bdb44c9358adcd3958__doc_13__v_1/neo4j/cypher/entities.csv' AS row
...
LOAD CSV WITH HEADERS FROM 'https://raw.githubusercontent.com/cenaia/graph/main/20260419T083144Z__task_tsk_887a54a413a646bdb44c9358adcd3958__doc_13__v_1/neo4j/cypher/observations.csv' AS row
...
LOAD CSV WITH HEADERS FROM 'https://raw.githubusercontent.com/cenaia/graph/main/20260419T083144Z__task_tsk_887a54a413a646bdb44c9358adcd3958__doc_13__v_1/neo4j/cypher/entity_has_observation.csv' AS row
...
LOAD CSV WITH HEADERS FROM 'https://raw.githubusercontent.com/cenaia/graph/main/20260419T083144Z__task_tsk_887a54a413a646bdb44c9358adcd3958__doc_13__v_1/neo4j/cypher/relationships.csv' AS row
...
LOAD CSV WITH HEADERS FROM 'https://raw.githubusercontent.com/cenaia/graph/main/20260419T083144Z__task_tsk_887a54a413a646bdb44c9358adcd3958__doc_13__v_1/neo4j/cypher/relationships.csv' AS row
WITH row WHERE row.canonical_type_en = 'COMPOSES'
MATCH (source:Entity {entity_id: row.source_entity_id})
MATCH (target:Entity {entity_id: row.target_entity_id})
CREATE (source)-[r:COMPOSES]->(target)
SET r.relationship_id = row.relationship_id,
    r.neo4j_rel_type = row.neo4j_rel_type,
    r.source = row.source,
    r.target = row.target,
...
LOAD CSV WITH HEADERS FROM 'https://raw.githubusercontent.com/cenaia/graph/main/20260419T083144Z__task_tsk_887a54a413a646bdb44c9358adcd3958__doc_13__v_1/neo4j/cypher/relationships.csv' AS row
WITH row WHERE row.canonical_type_en = 'CONSTRAINS'
MATCH (source:Entity {entity_id: row.source_entity_id})
MATCH (target:Entity {entity_id: row.target_entity_id})
CREATE (source)-[r:CONSTRAINS]->(target)
SET r.relationship_id = row.relationship_id,
    r.neo4j_rel_type = row.neo4j_rel_type,
    r.source = row.source,
    r.target = row.target,
...
LOAD CSV WITH HEADERS FROM 'https://raw.githubusercontent.com/cenaia/graph/main/20260419T083144Z__task_tsk_887a54a413a646bdb44c9358adcd3958__doc_13__v_1/neo4j/cypher/relationships.csv' AS row
WITH row WHERE row.canonical_type_en = 'EQUIPPED_WITH'
MATCH (source:Entity {entity_id: row.source_entity_id})
MATCH (target:Entity {entity_id: row.target_entity_id})
CREATE (source)-[r:EQUIPPED_WITH]->(target)
SET r.relationship_id = row.relationship_id,
    r.neo4j_rel_type = row.neo4j_rel_type,
    r.source = row.source,
    r.target = row.target,
...
LOAD CSV WITH HEADERS FROM 'https://raw.githubusercontent.com/cenaia/graph/main/20260419T083144Z__task_tsk_887a54a413a646bdb44c9358adcd3958__doc_13__v_1/neo4j/cypher/relationships.csv' AS row
WITH row WHERE row.canonical_type_en = 'INDICATES'
MATCH (source:Entity {entity_id: row.source_entity_id})
MATCH (target:Entity {entity_id: row.target_entity_id})
CREATE (source)-[r:INDICATES]->(target)
SET r.relationship_id = row.relationship_id,
    r.neo4j_rel_type = row.neo4j_rel_type,
    r.source = row.source,
    r.target = row.target,
...
LOAD CSV WITH HEADERS FROM 'https://raw.githubusercontent.com/cenaia/graph/main/20260419T083144Z__task_tsk_887a54a413a646bdb44c9358adcd3958__doc_13__v_1/neo4j/cypher/relationships.csv' AS row
WITH row WHERE row.canonical_type_en = 'REFLECTS'
MATCH (source:Entity {entity_id: row.source_entity_id})
MATCH (target:Entity {entity_id: row.target_entity_id})
CREATE (source)-[r:REFLECTS]->(target)
SET r.relationship_id = row.relationship_id,
    r.neo4j_rel_type = row.neo4j_rel_type,
    r.source = row.source,
    r.target = row.target,
...
LOAD CSV WITH HEADERS FROM 'https://raw.githubusercontent.com/cenaia/graph/main/20260419T083144Z__task_tsk_887a54a413a646bdb44c9358adcd3958__doc_13__v_1/neo4j/cypher/relationships.csv' AS row
WITH row WHERE row.canonical_type_en = 'REMEDIATES'
MATCH (source:Entity {entity_id: row.source_entity_id})
MATCH (target:Entity {entity_id: row.target_entity_id})
CREATE (source)-[r:REMEDIATES]->(target)
SET r.relationship_id = row.relationship_id,
    r.neo4j_rel_type = row.neo4j_rel_type,
    r.source = row.source,
    r.target = row.target,
...
LOAD CSV WITH HEADERS FROM 'https://raw.githubusercontent.com/cenaia/graph/main/20260419T083144Z__task_tsk_887a54a413a646bdb44c9358adcd3958__doc_13__v_1/neo4j/cypher/relationships.csv' AS row
WITH row WHERE row.canonical_type_en = 'USED_FOR_EVALUATION'
MATCH (source:Entity {entity_id: row.source_entity_id})
MATCH (target:Entity {entity_id: row.target_entity_id})
CREATE (source)-[r:USED_FOR_EVALUATION]->(target)
SET r.relationship_id = row.relationship_id,
    r.neo4j_rel_type = row.neo4j_rel_type,
    r.source = row.source,
    r.target = row.target,
